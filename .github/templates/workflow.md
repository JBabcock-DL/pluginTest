...
- **Project name:** pluginTest
- **Project ID:** `PVT_kwHOD9B30s4BUS3_`
- **Owner:** `JBabcock-DL`
- **Status field ID:** `PVTSSF_lAHOD9B30s4BUS3_zhBcDz4`

### Status Options

| Status | Option ID |
|---|---|
| Context Backlog | `480cc6fc` |
| In Research | `3d8ba648` |
| In Planning | `2bf8dd24` |
| In Build | `f68c32cf` |
| In Verification | `b6b7ad62` |
| Completed | `254eb9c6` |
...
gh project item-add 3 --owner JBabcock-DL --url https://github.com/JBabcock-DL/pluginTest/issues/{N}

# Move issue to a status column
gh api graphql -f query='
mutation {
  updateProjectV2ItemFieldValue(input: {
    projectId: "PVT_kwHOD9B30s4BUS3_"
    itemId: "{PVTI_...}"
    fieldId: "PVTSSF_lAHOD9B30s4BUS3_zhBcDz4"
    value: { singleSelectOptionId: "480cc6fc" }  # use the option ID for the target status from the Status Options table above
  }) {
    projectV2Item { id }
  }
}'
...
gh project item-list 3 --owner JBabcock-DL
```
